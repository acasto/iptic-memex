...
class OutputHandler:
    ...
    def __init__(self, config: Any) -> None:
        ...
        self._scope_stack: List[Dict[str, Any]] = []  # tool scope metadata
    ...
    class _ToolScopeContext:
        ...
        def __enter__(self) -> 'OutputHandler._ToolScopeContext':
            if self._entered:
                return self
        ...
        def status(self, message: str, level: OutputLevel = OutputLevel.INFO, **kwargs: Any) -> None:
    ...
    def tool_scope(
        ...
        *,
        ...
        autostart: bool = False,
        autoend: bool = False,
    ) -> 'OutputHandler._ToolScopeContext':
        """Provide a context manager to tag output generated by a tool call."""
        ...
        return OutputHandler._ToolScopeContext(self, meta, autostart=autostart, autoend=autoend)

    def current_tool_scope(self) -> Optional[Dict[str, Any]]:
        """Expose current tool scope metadata (if any)."""
